            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        <h5 class="mb-4 text-primary">Create a Listing</h5>
                        <form id="listing" name="listing" action="{{route('store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <input type="number" name="age" id="age" placeholder="Age" class="form-control" min="0" max="100" value="{{old('age')}}"/>
                            ...
                            <div class="mb-3">
                                <input type="number" name="contact" id="contact" placeholder="Phone number" class="form-control" value="{{old('contact')}}"/>
                            ...
                            <div class="mb-3 text-right">
                                <button type="submit" class="px-3 py-1 bg-primary text-white rounded">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
